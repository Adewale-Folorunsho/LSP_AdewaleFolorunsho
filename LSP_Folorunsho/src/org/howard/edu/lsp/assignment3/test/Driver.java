...
public class Driver {
	...
	public static void main(String[] args) {
	    ...
	    s1.add(4);
	    System.out.println("Set 1: " + s1.toString() + "\nSet 2: " + s2.toString());
	    System.out.println("\nClearing Set 1 by using clear() function: ");
	    s1.clear();
	    System.out.println("Set 1: " + s1.toString() + "\nSet 2: " + s2.toString());
	    ...
	    System.out.println("\nTesting largest() and smallest() functions");
	    try {
	    ...
	    System.out.println("\nAdding 26, 7, 8, 9 to Set 1 and 40, 7, 2, 5, 7 to Set 2: ");
	    s1.add(26);
	    s1.add(7);
	    s1.add(8);
	    s1.add(9);
	    ...
	    s2.add(7);
	    System.out.println("Set 1: " + s1.toString() + "\nSet 2: " + s2.toString());
	    System.out.println("\nTesting remove function by removing 7 and 0 from Set 2");
	    try {
			s2.remove(7);
		} catch (IntegerSetException e) {
